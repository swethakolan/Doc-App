...
export default function DoctorsPage() {
  ...
  return (
    <div className="flex justify-center bg-gray-100 min-h-screen py-4 px-3">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center gap-3 px-4 py-3">
          ...
          />
          <div>
            <h1 className="font-semibold text-base sm:text-lg text-black">Hello, Priya</h1>
        ...
        <div className="space-y-4 px-3 text-black">
          {filtered.map((dr) => (
            <div
              key={dr.id}
              onClick={() => router.push(`/book-appointment?id=${dr.id}`)}
